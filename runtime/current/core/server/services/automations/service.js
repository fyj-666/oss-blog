...
const get_scheduler_idempotency_key_1 = require("./get-scheduler-idempotency-key");
        ...
        const enqueuePollAt = async (date) => {
            ...
            try {
                ...
                schedulerAdapter.schedule((0, build_signed_job_1.buildSignedJob)({
                    ...
                    key,
                    getIdempotencyKey: (url) => (0, get_scheduler_idempotency_key_1.getSchedulerIdempotencyKey)(date, url),
                }));
            }
            catch (err) {
