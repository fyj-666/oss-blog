...
exports.ROUTE_SETTINGS_ERROR_CODES = void 0;
 ...
 */
exports.ROUTE_SETTINGS_ERROR_CODES = {
...
function codeForPath(path) {
    ...
    if (path.length === 2 && path[0] === 'taxonomies') {
        return exports.ROUTE_SETTINGS_ERROR_CODES.INVALID_PERMALINK;
    }
...
function validationError(at, reason, { help, code = exports.ROUTE_SETTINGS_ERROR_CODES.INVALID_ROUTE_SETTINGS, } = {}) {
 ...
 */
function toValidationError(error, basePath = [], value, code) {
    const issue = error.issues[0];
    const issuePath = issue.path;
    const path = [...basePath, ...issuePath];
    const resolvedCode = code ?? codeForPath(path) ?? exports.ROUTE_SETTINGS_ERROR_CODES.INVALID_ROUTE_SETTINGS;
