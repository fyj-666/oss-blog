...
const get_discount_window_1 = require("./get-discount-window");
/**
 ...
 */
async function hasActiveOffer(subscriptionModel, offersAPI, options = {}) {
    ...
    try {
        ...
        const discountWindow = (0, get_discount_window_1.getDiscountWindow)(subscriptionData, offer);
        if (discountWindow) {
