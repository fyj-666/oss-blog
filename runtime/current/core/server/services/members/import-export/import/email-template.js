...
exports.headingFor = void 0;
exports.default = renderImportEmail;
...
function renderImportEmail({ summary, imported, errorCount, siteUrl, membersUrl, emailRecipient, }) {
    const heading = exports.headingFor[summary];
    return `
<!doctype html>
<html>
  <head>
