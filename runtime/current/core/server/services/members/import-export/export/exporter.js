...
class MembersCSVExporter {
    ...
    _members;
    _customFields;
    constructor({ knex, members, customFields }) {
        this._knex = knex;
    ...
    createProcessingTransform(reference) {
        const assembleRelatedData = (memberIds) => this.assembleRelatedData(memberIds, reference.activeCustomFields);
    ...
    async assembleRelatedData(memberIds, activeCustomFields) {
