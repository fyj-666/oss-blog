...
exports.MppAdapter = exports.TEMPO_DECIMALS = exports.TEMPO_USDC = void 0;
exports.parseReceipt = parseReceipt;
const errors_1 = __importDefault(require("@tryghost/errors"));
const logging_1 = __importDefault(require("@tryghost/logging"));
const config_1 = __importDefault(require("../../../../shared/config"));
const pricing_1 = require("../pricing");
const deposit_address_store_1 = require("../stripe/deposit-address-store");
const stripe_client_options_1 = require("../stripe/stripe-client-options");
exports.TEMPO_USDC = '0x20c000000000000000000000b9537d11c60e8b50';
exports.TEMPO_DECIMALS = 6;
...
class MppAdapter {
    ...
    #mppxKey = null;
    #replayStore = null;
    constructor({ depositAddressStore, settingsCache: settings = settingsCache, pricing = new pricing_1.Pricing({ settingsCache: settings }), mppxFactory, stripeClientFactory, }) {
    ...
    async #run(request, terms) {
        const { Mppx, tempo, stripe: mppStripe, Store, } = this.mppxFactory ? this.mppxFactory() : require('mppx/server');
        const profileId = this.settingsCache.get('machine_payments_stripe_profile_id') ||
            config_1.default.get('machinePayments:mpp:networkId');
        ...
        try {
            recipient = await this.depositAddressStore.getOrCreateAddress({
                network: config_1.default.get('machinePayments:mpp:stripeNetwork') || 'tempo',
            });
        }
        catch (err) {
        ...
        const tempoCurrency = config_1.default.get('machinePayments:mpp:tempoCurrency') || exports.TEMPO_USDC;
        const testnet = config_1.default.get('machinePayments:mpp:testnet') === true;
        ...
        if (!this.#mppx || this.#mppxKey !== key) {
            ...
            if (hasTempo) {
                methods.push(tempo.charge({
                    ...
                    recipient,
                    testnet,
                    decimals: exports.TEMPO_DECIMALS,
        ...
        if (tempoCharge && stripeCharge) {
            return await this.#mppx.compose(['tempo/charge', tempoCharge], ['stripe/charge', stripeCharge])(request);
        }
        if (stripeCharge) {
    ...
    #getSecretKey() {
        return (config_1.default.get('machinePayments:mpp:secretKey') ||
