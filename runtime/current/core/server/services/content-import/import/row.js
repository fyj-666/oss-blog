...
exports.importableRowSchema = exports.postImportRowSchema = exports.EDITORIAL_POST_FIELDS = void 0;
const zod_1 = require("zod");
const temporal_polyfill_1 = require("temporal-polyfill");
exports.EDITORIAL_POST_FIELDS = [
    'title',
    'html',
    'markdown',
    'slug',
...
exports.postImportRowSchema = zod_1.z
    .object({
    title: zod_1.z
        .string()
        .default('')
        .transform((cell) => cell.trim()),
    html: zod_1.z.string().default(''),
    markdown: zod_1.z.string().default(''),
    slug: optionalCell,
...
const BOOLEAN_FIELDS = ['featured', 'show_title_and_feature_image'];
...
exports.importableRowSchema = exports.postImportRowSchema.superRefine((row, ctx) => {
    if (!row.title) {
...
function isValidDate(value) {
    ...
    try {
        temporal_polyfill_1.Temporal.PlainDate.from({ year: Number(isoDate[1]), month: Number(isoDate[2]), day: Number(isoDate[3]) }, { overflow: 'reject' });
        return true;
    }
    catch {
        return false;
