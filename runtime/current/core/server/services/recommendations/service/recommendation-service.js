...
class RecommendationService {
    ...
    async updateAllRecommendationsMetadata() {
        ...
        for (const recommendation of recommendations) {
            try {
                ...
                logging_1.default.error('[Recommendations] Failed to save updated metadata for recommendation ' +
                    recommendation.url.toString(), e);
            }
        }
    }
    ...
    async _updateRecommendationMetadata(recommendation) {
        ...
        try {
            ...
            logging_1.default.error('[Recommendations] Failed to update metadata for recommendation ' +
                recommendation.url.toString(), e);
        }
    }
