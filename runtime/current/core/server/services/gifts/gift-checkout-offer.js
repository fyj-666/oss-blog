...
exports.resolveGiftDuration = resolveGiftDuration;
exports.validateGiftCheckoutOffer = validateGiftCheckoutOffer;
...
function invalidGiftOffer(context) {
    return new errors_1.default.BadRequestError({
        message: 'Bad Request.',
        context,
    });
}
