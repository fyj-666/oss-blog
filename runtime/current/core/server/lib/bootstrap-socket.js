...
const getErrorCode = (err) => err && typeof err === 'object' && 'code' in err && typeof err.code === 'string'
    ? err.code
    : undefined;
const isValidPort = (port) => typeof port === 'number' && Number.isInteger(port) && port >= 1 && port <= 65535;
const hasSocketAddress = (socketAddress) => typeof socketAddress?.host === 'string' &&
    Boolean(socketAddress.host) &&
