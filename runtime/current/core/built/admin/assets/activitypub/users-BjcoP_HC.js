...
import { A as l, B as u, C as d, D as f, E as p, F as m, I as h, L as g, M as _, N as v, O as y, P as b, R as x, S, T as C, V as w, _ as T, b as ee, j as E, k as D, p as te, v as O, w as k, x as A, y as j, z as M } from "./chunk-KS7C4IRE-Ck3O4oo2.js";
...
var rt = (e) => {
	...
	return s(async (n, { method: r = "GET", headers: i = {}, body: a, credentials: o = "include", timeout: s, retry: c = !0, responseType: l, onUploadProgress: u } = {}) => {
		...
		}, y = u ? ft.bind(null, u) : fetch, b = s ? setTimeout(() => d.abort(), s) : void 0;
		try {
			for (; p === 0 || c;) try {
				return await nt(await y(n, f), { responseType: l });
			} catch (e) {
				if (m = Date.now() - h, c && _.some((t) => e instanceof t) && m <= 15e3) {
					await new Promise((e) => {
						setTimeout(e, g[p] || g[g.length - 1]);
					}), p += 1;
					continue;
				}
				if (p !== 0 && t && j("Request failed after multiple attempts", { extra: v() }), e && typeof e == "object" && "name" in e && e.name === "AbortError") throw new he();
				if (e instanceof X && ut(n)) throw dt(), new ve(e.response, e.data, { cause: e });
				let r = e;
...
var bt = (e) => ({ searchParams: n, ...r } = {}) => {
	let i = $(e.path, n || e.defaultSearchParams), a = pt(), o = $e(), s = yt(e.permissions), l = W({
		...r,
	...
	let a = pt(), o = $e(), s = yt(e.permissions), l = r || e.defaultNextPageParams || (() => ({})), u = pe({
		...i,
		enabled: s && (i.enabled ?? !0),
		queryKey: [e.dataType, $(e.path, n || e.defaultSearchParams)],
		queryFn: ({ pageParam: t }) => a($(e.path, t || n || e.defaultSearchParams), { ...e }),
	...
	let { defaultSearchParams: a, body: o, ...s } = i, c = $(t, r || a), l = n && o?.(n), u;
	...
	let o = pt(), c = A(), { onUpdate: l, onInvalidate: u, onDelete: d } = T();
	return G({
		mutationFn: (r) => St({
			fetchApi: o,
			path: e(r),
...
//# sourceMappingURL=users-BjcoP_HC.js.map